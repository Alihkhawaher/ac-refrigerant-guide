...
def main():
    ...
    # All test temperatures correspond to EXACT °F grid points in VERIFIED_PT_DATA
    # (-17.8C=0F, 4.4C=40F, 21.1C=70F, 37.8C=100F, 48.9C=120F, 65.6C=150F)
    # so expected values are direct table entries (no interpolation error).
    test_points = {
        "R-134a": [(-17.8, 6.5), (4.4, 35.0), (21.1, 71.1), (37.8, 124.2), (48.9, 171.2), (65.6, 262.9)],
        "R-22": [(-17.8, 23.9), (4.4, 68.5), (21.1, 121.4), (37.8, 195.7), (48.9, 259.5), (65.6, 377.9)],
        "R-410A": [(-17.8, 48.4), (4.4, 118.8), (21.1, 201.7), (37.8, 318.5), (48.9, 419.5), (65.6, 613.9)],
        "R-32": [(-17.8, 49.3), (4.4, 121.0), (21.1, 205.8), (37.8, 325.7), (48.9, 429.3), (65.6, 628.8)],
    }
